...
//        rtmpUnity = new RtmpUnity( sf,UnityPlayerActivity.this);

        unitySurface =  findViewById(R.id.surface_unity);
     ...
     void initUnitySurface(SurfaceView unitySurface) {
        unitySurface.getHolder().setFormat(PixelFormat.RGB_565);
